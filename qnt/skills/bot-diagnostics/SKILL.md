...
description: Diagnose and fix Cipher system issues
triggers:
  - health check
  - is the bot running
  - something is wrong
...
8. Append to QNT.md Known Issues Log:
   ...
   /Users/aatifquamre/cipher/qnt/.issues_log
