...
import { debugLogger } from '@google/qnt-cli-core';
...
describe('loadSettings', () => {
  ...
  const mockGeminiHomeDir = path.join(mockHomeDir, '.qnt');
  const mockGeminiWorkspaceDir = path.join(mockWorkspaceDir, '.qnt');
