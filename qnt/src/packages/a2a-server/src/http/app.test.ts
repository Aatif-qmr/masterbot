...
import { MockTool } from '@google/qnt-cli-core/src/test-utils/mock-tool.js';
...
vi.mock('@google/qnt-cli-core', async () => {
  const actual = await vi.importActual('@google/qnt-cli-core');
  return {
    ...actual,
