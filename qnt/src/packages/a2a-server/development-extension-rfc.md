# RFC: QNT CLI A2A Development-Tool Extension

## 1. Introduction

### 1.1 Overview

To standardize client integrations with the QNT CLI agent, this document
...
required for rich, interactive workflows with the QNT CLI agent.

### 1.2 Motivation

Recent work integrating QNT CLI with clients like Zed and Gemini Code
...
- **Ecosystem Alignment**: Aligns QNT CLI with a growing industry standard,
...
workflows between a client and the QNT CLI agent. It consists of a
...
// Configuration settings for the QNT CLI agent.
