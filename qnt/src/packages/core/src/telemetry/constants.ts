...
export const SERVICE_NAME = 'qnt';
export const SERVICE_DESCRIPTION =
  'qnt is an open-source AI agent that brings the power of Gemini directly into your terminal. It is designed to be a terminal-first, extensible, and powerful tool for developers, engineers, SREs, and beyond.';

// qnt specific semantic conventions
