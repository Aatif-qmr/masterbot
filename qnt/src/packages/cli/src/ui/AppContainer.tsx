    ...
    async (authType: AuthType | undefined, scope: LoadableSettingScope) => {
      if (authType) {
        ...
        if (
          ...
          writeToStdout(`
----------------------------------------------------------------
Logging in with Google... Restarting QNT CLI to continue.
----------------------------------------------------------------
          `);
          await relaunchApp();
        }
  ...
  useEffect(() => {
    ...
    // Note: We don't need to reset the window title on exit because QNT CLI is already doing that elsewhere
  }, [
    streamingState,
    thought,
